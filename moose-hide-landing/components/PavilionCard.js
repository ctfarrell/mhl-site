...
export default function PavilionCard(props) {
    ...
    <div className="flex flex-col place-items-center text-left place-self-auto group ">
        <div className="flex flex-1 flex-row h-18 w-full justify-between rounded-l-lg bg-primary z-10">
        ...
        <div className = "flex w-full justify-between space-x-10 h-80 flex-row">
            ...
            <div className = "container flex-none object-contain justify-self-right h-2/3 w-1/3 block z-10">
                <Image src ={props.pavilionImage2.src} alt="pavilion image" layout = "responsive" height={props.pavilionImage2.height} width = {props.pavilionImage2.width} className="object-fill z-10" />
            </div>
        </div>
    </div>
    )
