...
export default function PavilionList(props) {
    ...
    return(
        <PavilionCard key={pav.pavilion_id} pavilionCapacity = {pav.pavilion_capacity} pavilionImage2 = {pav.pavilion__image} pavilionName={pav.pavilion_name} pavilionText={pav.pavilion_text} pavilionImage = {pav.pavilion_image}/>
    )
}
)
    )
